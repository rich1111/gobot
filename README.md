...
[![GoDoc](https://godoc.org/github.com/rich1111/gobot?status.svg)](https://godoc.org/github.com/rich1111/gobot)
...
Get the Gobot package by running this command: `go get -d -u github.com/rich1111/gobot`
...
To activate the API, import the `github.com/rich1111/gobot/api` package and instantiate the `API` like this:
