...
Connecting to the Mindwave from Ubuntu or any other Linux-based OS can be done entirely from the command line using [Gort](https://github.com/rich1111/gort) CLI commands. Here are the steps.
...
import (
	...
	"github.com/rich1111/gobot/platforms/neurosky"
)
